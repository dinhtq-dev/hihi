...
export function WhyChooseUs() {
  return (
    <section className="py-[30px] lg:py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6 lg:mb-12">
        <div className="text-center">
          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-[60px] font-bold text-foreground">
            Why Choose Us For <span className="text-primary">Company Formation Service</span>
          </h2>
        </div>
      </div>

      {/* Mobile: Vertical Static Grid */}
      ...
      {/* Desktop: First Row - Scrolling Left */}
      ...
      {/* Desktop: Second Row - Scrolling Right */}
