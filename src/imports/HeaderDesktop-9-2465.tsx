import svgPaths from "./svg-gg7oewng06";
  ...
  return (
    <div className="backdrop-blur-[15px] backdrop-filter bg-[rgba(255,255,255,0.9)] relative shadow-[0px_4px_16px_0px_rgba(180,180,180,0.16)] size-full" data-name="Header Desktop">
      <div className="absolute bottom-0 h-[63px] right-0 w-[1635px]">
        <div className="absolute flex h-[100px] items-center justify-center left-0 top-0 w-[1635px]">
          <div className="flex-none rotate-[180deg] scale-y-[-100%]">
            <div className="h-[100px] relative w-[1635px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1635 100">
                <path d={svgPaths.p156cd200} fill="var(--fill-0, #7D1316)" id="Rectangle 9087" />
              </svg>
            </div>
          </div>
        </div>
