import svgPaths from "./svg-go5ccqx3yu";
        ...
        <div className="h-[6.998px] relative w-[9px]" data-name="Polygon">
          <div className="absolute bottom-1/4 left-[6.7%] right-[6.7%] top-0">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.79423 5.24863">
              <path d={svgPaths.p2d0a3200} fill="var(--fill-0, #343A40)" id="Polygon" />
            </svg>
          </div>
        </div>
      </div>
...
export default function HeaderDesktop() {
  return (
    <div className="backdrop-blur-[15px] backdrop-filter bg-[rgba(255,255,255,0.9)] relative shadow-[0px_4px_16px_0px_rgba(180,180,180,0.16)] size-full" data-name="Header Desktop">
      <div className="absolute bottom-0 h-[63px] right-0 w-[1635px]">
        <div className="absolute flex h-[63px] items-center justify-center left-[20px] top-0 w-[1615px]">
          <div className="flex-none rotate-[180deg] scale-y-[-100%]">
            <div className="h-[63px] relative w-[1615px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1615 63">
                <path d={svgPaths.pa54ad80} fill="var(--fill-0, #7D1316)" id="Rectangle 9087" />
              </svg>
            </div>
          </div>
        </div>
        <div className="absolute content-stretch flex h-[63px] items-center justify-between left-[54px] top-1/2 translate-y-[-50%] w-[1481px]">
      ...
      <div className="absolute contents left-[100px] top-[26px]" data-name="Logo">
        <div className="absolute contents left-[100px] top-[26px]" data-name="Group">
          <div className="absolute h-[44.393px] left-[187.95px] top-[32.74px] w-[112.054px]" data-name="Group">
          ...
          <div className="absolute h-[57.894px] left-[100px] top-[26px] w-[79.059px]" data-name="Group">
      ...
      <div className="absolute content-stretch flex flex-col items-start pl-0 pr-[100px] py-0 right-0 top-0 w-[1635px]">
        <div className="h-[47px] relative shrink-0 w-full">
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex items-center justify-between pl-[80px] pr-0 py-0 relative size-full">
              <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="Left Block">
                <div className="relative shrink-0 size-[24px]" data-name="Hotline">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                    <g clipPath="url(#clip0_9_1526)" id="Hotline">
                      <path d={svgPaths.p6058e80} fill="var(--fill-0, #343A40)" id="Vector" />
                    </g>
                    <defs>
                ...
                <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#343a40] text-[0px] text-nowrap">
                  <p className="leading-[24px] text-[16px]">
                    <span>{`Consultant & Support (Toll free):`}</span>
                    <span className="text-[#f12e36]">{` +852 3702 1796`}</span>
                  </p>
                </div>
              </div>
              <div className="content-stretch flex gap-[20px] items-center relative shrink-0">
                <div className="content-stretch flex gap-[8px] items-center justify-end relative shrink-0">
                  ...
                  <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#343a40] text-[16px] text-nowrap">
                ...
                <div className="content-stretch flex gap-[8px] items-center justify-end relative shrink-0" data-name="Frame">
                  <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#343a40] text-[16px] text-center text-nowrap">
                  ...
                  <div className="h-[18px] overflow-clip relative shrink-0 w-[27px]" data-name="Icons / Flag / United States">
                    <div className="absolute h-[15.724px] left-[calc(50%+0.5px)] top-[calc(50%+0.36px)] translate-x-[-50%] translate-y-[-50%] w-[24px]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 15.7241">
                        <g id="Group 56333">
                          <path d={svgPaths.pcde1200} fill="var(--fill-0, #F5F5F5)" id="Vector" />
                          <g id="Group">
                            <path d={svgPaths.p30191100} fill="var(--fill-0, #FF4B55)" id="Vector_2" />
                            <path d={svgPaths.p2a60bd00} fill="var(--fill-0, #FF4B55)" id="Vector_3" />
                            <path d={svgPaths.p33079200} fill="var(--fill-0, #FF4B55)" id="Vector_4" />
                            <path d={svgPaths.p34f6fe00} fill="var(--fill-0, #FF4B55)" id="Vector_5" />
                            <path d={svgPaths.p2f457aa0} fill="var(--fill-0, #FF4B55)" id="Vector_6" />
                            <path d={svgPaths.p1b36ab00} fill="var(--fill-0, #FF4B55)" id="Vector_7" />
                            <path d={svgPaths.p3bd4d000} fill="var(--fill-0, #FF4B55)" id="Vector_8" />
                          </g>
                          <path d={svgPaths.p6f8a500} fill="var(--fill-0, #41479B)" id="Vector_9" />
                          <g id="Group_2">
                            <path d={svgPaths.p23888880} fill="var(--fill-0, #F5F5F5)" id="Vector_10" />
                            <path d={svgPaths.p5b49680} fill="var(--fill-0, #F5F5F5)" id="Vector_11" />
                            <path d={svgPaths.p1a8fb000} fill="var(--fill-0, #F5F5F5)" id="Vector_12" />
                            <path d={svgPaths.pfefe000} fill="var(--fill-0, #F5F5F5)" id="Vector_13" />
                            <path d={svgPaths.p3fcfd400} fill="var(--fill-0, #F5F5F5)" id="Vector_14" />
                            <path d={svgPaths.p1d1c1200} fill="var(--fill-0, #F5F5F5)" id="Vector_15" />
                            <path d={svgPaths.pf676090} fill="var(--fill-0, #F5F5F5)" id="Vector_16" />
                            <path d={svgPaths.p3c07f200} fill="var(--fill-0, #F5F5F5)" id="Vector_17" />
                            <path d={svgPaths.p16fcafe0} fill="var(--fill-0, #F5F5F5)" id="Vector_18" />
                            <path d={svgPaths.p18928600} fill="var(--fill-0, #F5F5F5)" id="Vector_19" />
                            <path d={svgPaths.p30b77880} fill="var(--fill-0, #F5F5F5)" id="Vector_20" />
                            <path d={svgPaths.p89f0500} fill="var(--fill-0, #F5F5F5)" id="Vector_21" />
                            <path d={svgPaths.p1f5602f0} fill="var(--fill-0, #F5F5F5)" id="Vector_22" />
                            <path d={svgPaths.p19951100} fill="var(--fill-0, #F5F5F5)" id="Vector_23" />
                            <path d={svgPaths.p1eeaee80} fill="var(--fill-0, #F5F5F5)" id="Vector_24" />
                            <path d={svgPaths.p29476e80} fill="var(--fill-0, #F5F5F5)" id="Vector_25" />
                            <path d={svgPaths.p8285600} fill="var(--fill-0, #F5F5F5)" id="Vector_26" />
                            <path d={svgPaths.pea25e00} fill="var(--fill-0, #F5F5F5)" id="Vector_27" />
                            <path d={svgPaths.p3de23180} fill="var(--fill-0, #F5F5F5)" id="Vector_28" />
                            <path d={svgPaths.p254a9000} fill="var(--fill-0, #F5F5F5)" id="Vector_29" />
                            <path d={svgPaths.p4c52570} fill="var(--fill-0, #F5F5F5)" id="Vector_30" />
                            <path d={svgPaths.p271500} fill="var(--fill-0, #F5F5F5)" id="Vector_31" />
                            <path d={svgPaths.p2f73500} fill="var(--fill-0, #F5F5F5)" id="Vector_32" />
                            <path d={svgPaths.p26411900} fill="var(--fill-0, #F5F5F5)" id="Vector_33" />
                            <path d={svgPaths.p4c28a00} fill="var(--fill-0, #F5F5F5)" id="Vector_34" />
                            <path d={svgPaths.p25d58100} fill="var(--fill-0, #F5F5F5)" id="Vector_35" />
                            <path d={svgPaths.p27358300} fill="var(--fill-0, #F5F5F5)" id="Vector_36" />
                            <path d={svgPaths.pebf4b00} fill="var(--fill-0, #F5F5F5)" id="Vector_37" />
                            <path d={svgPaths.p15f11900} fill="var(--fill-0, #F5F5F5)" id="Vector_38" />
                            <path d={svgPaths.p282a7780} fill="var(--fill-0, #F5F5F5)" id="Vector_39" />
                            <path d={svgPaths.p9218400} fill="var(--fill-0, #F5F5F5)" id="Vector_40" />
                            <path d={svgPaths.p2b2e9600} fill="var(--fill-0, #F5F5F5)" id="Vector_41" />
                            <path d={svgPaths.p6823880} fill="var(--fill-0, #F5F5F5)" id="Vector_42" />
                            <path d={svgPaths.p1005fa00} fill="var(--fill-0, #F5F5F5)" id="Vector_43" />
                            <path d={svgPaths.p1c57f000} fill="var(--fill-0, #F5F5F5)" id="Vector_44" />
                            <path d={svgPaths.p39077f80} fill="var(--fill-0, #F5F5F5)" id="Vector_45" />
                            <path d={svgPaths.pa61c9c0} fill="var(--fill-0, #F5F5F5)" id="Vector_46" />
                            <path d={svgPaths.pdf19500} fill="var(--fill-0, #F5F5F5)" id="Vector_47" />
                            <path d={svgPaths.p1b2b2d80} fill="var(--fill-0, #F5F5F5)" id="Vector_48" />
                            <path d={svgPaths.p25c576f0} fill="var(--fill-0, #F5F5F5)" id="Vector_49" />
                            <path d={svgPaths.p494c800} fill="var(--fill-0, #F5F5F5)" id="Vector_50" />
                          </g>
                        </g>
                      </svg>
                    </div>
